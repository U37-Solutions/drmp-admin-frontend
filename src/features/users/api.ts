...
import type { UserDTO, UserResetPassword } from './types';
...
export const resetUserPassword = async (passwords: UserResetPassword) =>
  await apiClient.post(`/users/change-password`, passwords).then((res) => res.data);
